  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="mx-auto w-full max-w-2xl px-4 py-8 sm:px-6">
        ...
        <div className="mb-4 flex flex-col gap-2 rounded-xl border border-violet/40 bg-carbon p-4 sm:flex-row sm:items-center sm:justify-between">
          <div className="min-w-0 sm:flex-1">
            ...
            <p className="break-all text-xs text-ivory/60">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <a
              href="/"
              target="_blank"
              className="py-1 text-sm text-ivory/60 hover:text-ivory"
            >
              View
            </a>
            <Link
        ...
        <div className="space-y-2">
          {siteList.map((site) => (
            <div
              key={site.id}
              className="flex flex-col gap-2 rounded-xl border border-ash/60 bg-carbon p-4 sm:flex-row sm:items-center sm:justify-between"
            >
              <div className="min-w-0 sm:flex-1">
                <p className="text-sm font-medium">
        ...
        <form
          action={createSite}
          className="mt-6 flex flex-col gap-2 rounded-xl border border-dashed border-ash bg-carbon/50 p-3 sm:flex-row sm:flex-wrap sm:items-center"
        >
          <select
